...
<html lang="en">
  ...
  <body>
    ...
    <header>
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url('custom_public/images/cover2.jpg')">
            <div class="carousel-caption d-none d-md-block">
              
            </div>
          </div>
          <!-- Slide Two - Set the background image for this slide in the line below -->
          <div class="carousel-item" style="background-image: url('custom_public/images/cover.png')">
            <div class="carousel-caption d-none d-md-block">
              
            </div>
          </div>
          <!-- Slide Three - Set the background image for this slide in the line below -->
          <div class="carousel-item" style="background-image: url('custom_public/images/cover3.jpg')">
            <div class="carousel-caption d-none d-md-block">
    ...
    <div class="container">
      ...
      <h1 class="my-4">Welcome to Clothing.com</h1>
      ...
      <div class="row">
        <div class="col-lg-4 mb-4">
          <div class="card h-100">
           ...
           <img class="card-img-top" src="custom_public/images/casual blazer.jpg" onerror="this.src = 'http://placehold.it/700x400'" alt=""> 
            <div class="card-body">
            </div>
        ...
        <div class="col-lg-4 mb-4">
          <div class="card h-100">
            ...
            <img class="card-img-top" src="custom_public/images/kurti.jpeg" onerror="this.src = 'http://placehold.it/700x400'" alt=""> 
            <div class="card-body">
        ...
        <div class="col-lg-4 mb-4">
          <div class="card h-100">
            ...
            <img class="card-img-top" src="custom_public/images/boy.jpg" onerror="this.src = 'http://placehold.it/700x400'" alt=""> 
            <div class="card-body">
