                ...
                <form method="post" action="/login" id="login">
                  <input type="hidden" name="_token" value="{{csrf_token()}}">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="usernameEmail" type="text" aria-describedby="emailHelp" placeholder="Enter admin email" name="admin_email" value="{{old('admin-email')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="password" type="password" placeholder="Enter Password" name="admin_password">
